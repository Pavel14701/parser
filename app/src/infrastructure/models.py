...
class Object(Base):
    ...
    url: Mapped[bool] = mapped_column("url", sa.String(length=500), unique=True)
    ...
    region: Mapped[str] = mapped_column("region", sa.String(60))
    city: Mapped[str] = mapped_column("city", sa.String(60), index=True)
    ...
    latitude: Mapped[Decimal] = mapped_column("latitude", sa.Numeric(10,8))
    longitude: Mapped[Decimal] = mapped_column("longitude", sa.Numeric(10,8))
    price_byn: Mapped[Decimal] = mapped_column("price_byn", sa.Integer)
    price_usd: Mapped[Decimal] = mapped_column("price_usd", sa.Integer, index=True)
    price_m2: Mapped[Optional[Decimal]] = mapped_column("price_m2", sa.Integer, index=True)
    build_type: Mapped[str] = mapped_column("build_type", sa.String(length=60))
    ...
    living_area: Mapped[Decimal] = mapped_column("living_area", sa.Numeric(6,2))
    kitchen_area: Mapped[Decimal] = mapped_column("kitchen_area", sa.Numeric(6,2))
    repair: Mapped[Optional[str]] = mapped_column("repair", sa.String(length=60), nullable=True)
    balcony: Mapped[Optional[str]] = mapped_column("balcony", sa.String(length=60), nullable=True)
    number_balcony: Mapped[Optional[str]] = mapped_column("number_balcony", sa.String(length=60), nullable=True)
    bath: Mapped[str] = mapped_column("bath", sa.String(length=20), nullable=True)
...
class Photos(Base):
    ...
    url: Mapped[str] = mapped_column("url", sa.String(length=500))